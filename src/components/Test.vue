<template>
  <div id="app">
    ...
    <vue-clap-button class="icon" icon="star" :size="30" :initClicked="1"></vue-clap-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      cancel() {
        console.log("canceled all clap");
      },
      clap(clapsCount) {
        console.log(`Get ${clapsCount} claps`);
        console.log(`You can also call ref.getClaps() : ${this.$refs.clap.getClaps()}`);
      }
    }
  }
</script>
